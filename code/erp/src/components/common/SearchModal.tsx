      ...
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg flex flex-col max-h-[80vh]">
        ...
        <div className="p-4 border-b">
          <div className="relative">
            ...
            {isLoading && <Loader2 className="absolute right-3 top-2.5 text-blue-500 animate-spin" size={20} />}
          </div>
        </div>
            ...
            <ul className="space-y-1">
              {results.map((item, index) => (
                <li 
                  ...
                  className="p-3 hover:bg-blue-50 rounded-lg cursor-pointer transition-colors border border-transparent hover:border-blue-100"
                >
                  {renderItem(item)}
                </li>
              ))}
