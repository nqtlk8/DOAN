...
public class CostLayerTest {
    ...
    public void consume_partialLayer() {
        CostLayer layer = CostLayer.fromInbound(1L, 1L, new BigDecimal("100"), new BigDecimal("10000"), UUID.randomUUID());
    ...
    public void consume_exactLayer() {
        CostLayer layer = CostLayer.fromInbound(1L, 1L, new BigDecimal("50"), new BigDecimal("10000"), UUID.randomUUID());
    ...
    public void consume_moreThanAvailable() {
        CostLayer layer = CostLayer.fromInbound(1L, 1L, new BigDecimal("20"), new BigDecimal("10000"), UUID.randomUUID());
