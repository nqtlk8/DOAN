...
public class AuthService {
    ...
    public AuthResponse login(String username, String password) {
        ...
        String branchId = primaryRole.getBranch() != null ? primaryRole.getBranch().getId().toString() : null;
        
        String accessTokenId = UUID.randomUUID().toString();
        String refreshTokenId = UUID.randomUUID().toString();

        String accessToken = tokenProvider.generateToken(username, roleCode, branchId, accessTokenId);
        String refreshToken = tokenProvider.generateRefreshToken(username, roleCode, branchId, refreshTokenId);
